              ...
              <div className={styles.stepContainer}>
                <div className={styles.step} onClick={() => handleStepClick(1)}>
                  ...
                  <div className={styles.descriptionMobile}>
                    <p>"Vote Room"을 클릭해 방을 생성합니다.</p>
                  </div>
                  {expandedStep === 1 && (
                    <div className={styles.detailText}>
                      <h5>상세 설명</h5>
                      <p>"Vote Room" 버튼을 클릭하면 방 생성 모달이 열립니다. 여기서 방의 기본 설정을 할 수 있습니다.</p>
                    </div>
                  )}
                </div>
                  ...
                  <div className={styles.stepHeader}>
                    ...
                    <div className={styles.stepContent}>
                      ...
                      <div className={styles.descriptionDesktop}>
                        ...
                        <ul>
                          <li><strong>직접가기</strong>: 방문 가능한 식당들을 검색</li>
                          <li><strong>배달</strong>: 배달 가능한 식당들을 검색</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className={styles.descriptionMobile}>
                    <p>약속 장소 및 원하는 식당 옵션을 설정합니다.</p>
                    <ul>
                      <li><strong>직접가기</strong>: 방문 가능한 식당들을 검색</li>
                      <li><strong>배달</strong>: 배달 가능한 식당들을 검색</li>
                    </ul>
                ...
                <div className={styles.step} onClick={() => handleStepClick(3)}>
                  ...
                  <div className={styles.descriptionMobile}>
                    <p>생성된 방 ID 공유를 통해 멤버를 초대해보세요.</p>
                  </div>
                  {expandedStep === 3 && (
                    <div className={styles.detailText}>
                      <div className={styles.detailContent}>
                ...
                <div className={styles.step} onClick={() => handleStepClick(6)}>
                  ...
                  <div className={styles.descriptionMobile}>
                    <p>투표 결과를 확인하여 최종 식당을 선정해보세요.</p>
                  </div>
                  {expandedStep === 6 && (
                    <div className={styles.detailText}>
                      <h5>상세 설명</h5>
                      <p>투표가 완료된 유저는 실시간 투표 결과를 확인할 수 있습니다.</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className={styles.guideSection}>
              ...
              <div className={styles.stepContainer}>
                <div className={styles.step} onClick={() => handleStepClick(1)}>
                  ...
                  <div className={styles.descriptionMobile}>
                    <p>"Random Room"을 클릭해 방을 생성합니다.</p>
                  </div>
                  {expandedStep === 1 && (
                    <div className={styles.detailText}>
                      <h5>상세 설명</h5>
                      <p>"Random Room" 버튼을 클릭하면 방 생성 모달이 열립니다. 여기서 방의 기본 설정을 할 수 있습니다.</p>
                    </div>
                  )}
                </div>
                ...
                <div className={styles.step} onClick={() => handleStepClick(3)}>
                  ...
                  <div className={styles.descriptionMobile}>
                    <p>조건에 맞는 식당이 필터링돼 후보로 올라갑니다.</p>
                    <ul>
                      <li>최대한 다양한 메뉴를 추천받을 수 있도록</li>
                      <li>위치 및 반경 내의 식당들 중에서 선택</li>
                    </ul>
                  </div>
                  {expandedStep === 3 && (
                    <div className={styles.detailText}>
                ...
                <div className={styles.step} onClick={() => handleStepClick(4)}>
                  ...
                  <div className={styles.descriptionMobile}>
                    <p>룰렛을 돌려 최종 식당을 결정합니다.</p>
                    <ul>
                      <li>선택된 후보들로 룰렛 진행</li>
                      <li>후보가 마음에 안 든다면 후보 리셋도 가능</li>
                    </ul>
                  </div>
                  {expandedStep === 4 && (
                    <div className={styles.detailText}>
